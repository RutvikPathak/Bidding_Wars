...
<!-- content -->
	...
	<div class="col-md-7 content-lgrid">
				...
				<div class="img-box"><img src="images/p1.jpg" alt="image" class="img-responsive zoom-img"></div>
					<div class="info-box">
						<div class="info-content simpleCart_shelfItem">
									...
									<p><span class="item_price">Rs. 500</span></p>
									<span class="separator"></span>
		...
		<div class="col-sm-6 content-img-right">
			<h3>Check out our<span>New latest</span> Arrivals</h3>
		</div>
		
		<div class="col-sm-6 content-img-right" style="padding-top: 50px;">
                    <h3> <span>Shop Now </span> Discover our deal of the day and featured deals</h3>
		</div>
		<div class="col-sm-6 content-img-left text-center">
			<div class="content-grid-effect slow-zoom vertical">
				<div class="img-box"><img src="images/p2.jpg" alt="image" class="img-responsive zoom-img"></div>
					<div class="info-box">
						<div class="info-content simpleCart_shelfItem">
							...
							<span class="separator"></span>
                                                        <h5 style="color:white;">Start upto</h5>
							<p><span class="item_price">Rs. 250</span></p>
							<span class="separator"></span>
							<a class="item_add hvr-outline-out button2" href="#">Start Bid</a>
						</div>
					</div>
