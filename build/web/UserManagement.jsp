            ...
            <div class="bootstrap-tab-text-grids" style="margin:100px;">
                <div class="bootstrap-tab-text-grid">
                    ...
                    <div class="bootstrap-tab-text-grid-right">
                        ...
                        <form>
                            Total Number of User : <input type="text" name="usercounter" style="margin:30px; border-style:none;">
                            ...
                            <table>
                                ...
                                <tr style="border-bottom: 2px solid #ECECEC;">
                                    <td style="color:grey ; padding:30px; size:20px ;">U_ID.</td>
                                    <td style="color:grey ; padding:30px; size:20px ;">Dp</td>
                                    <td style="color:grey ; padding:30px; size:20px ;">User Name</td>
                                ...
                                <%
                                    if (request.getAttribute("UserManagement") != null) {
                                        ArrayList<UserTable> al = (ArrayList<UserTable>) request.getAttribute("UserManagement");
                                        if (al.size() > 0) {

                                            for (int i = 0; i < al.size(); i++) {
                                                UserTable ut = al.get(i);
                                %>

                                <tr>
                                    <td style=" padding:30px; size:20px ;"><%= ut.getUserID()%>                    </td>
                                    <td style=" padding:30px; size:20px ;"><img src="images/users/<%= ut.getUserProfilePic()%>" style="height:30px; width:30px;"> </td>
                                    <td style=" padding:30px; size:20px ;"><%= ut.getUserFirstName()%>   <%= ut.getUserLastName()%></td>
                                    <td style=" padding:30px; size:20px ;"><%= ut.getUserAddress()%>               </td>
                                    <td style=" padding:30px; size:20px ;"><%= ut.getUserContact()%>               </td>
